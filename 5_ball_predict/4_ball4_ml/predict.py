"""
4_ball4_ml/predict.py - ball4 예측

ball1, ball2, ball3, ball6가 주어졌을 때 ball4 예측
"""
...
def predict_ball4(
    ...
    Args:
        used_balls: 이미 사용된 번호들 {ball1, ball2, ball3, ball6}
        past_data: 과거 데이터
        top_k: 상위 K개 반환
    ...
    # ball4 빈도
    freq_10 = Counter(d['ball4'] for d in recent_10)
    freq_20 = Counter(d['ball4'] for d in recent_20)
