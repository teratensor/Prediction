"""
5_ball5_ml/predict.py - ball5 예측

ball1~ball4, ball6가 주어졌을 때 ball5 예측
"""
...
def predict_ball5(
    ...
    Args:
        used_balls: 이미 사용된 번호들 {ball1, ball2, ball3, ball4, ball6}
        past_data: 과거 데이터
        top_k: 상위 K개 반환
    ...
    # ball5 빈도
    freq_10 = Counter(d['ball5'] for d in recent_10)
    freq_20 = Counter(d['ball5'] for d in recent_20)
